...
* 우선, 적합한 데이터셋을 찾지 못하여 위스콘신 유방암 진단데이터를 가지고 종양의 면적을 최대화 시키는 조건을 **베이지안 최적화 방법**으로 알아보고 어떤 요소가 가장 영향을 크게 미치는지 분석해보고자 한다.
* **이 프로젝트의 궁극적인 목표는 베이지안 최적화라는 방법을 소개하고자 하는 것이며, 어떤 과정으로 이뤄지며 결과는 어떠한지 자유로운 분석을 정리보고자 한다.**
